/*
Funções são blocos de construção. Nós escrevevos um trecho de código que poderá ser reautilizado.
Para usar uma função, você deve defini-la em algum lugar e chamar no escopo onde precisar.
*/
